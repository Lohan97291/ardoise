...
const ZONE_C_PERIODS_2026_2027 = [
...
function getZoneCSchoolRhythm(date: Date, timetable: ReturnType<typeof getTimetable>) {
...
function JournalPage() {
  ...
  const schoolRhythm = useMemo(() => getZoneCSchoolRhythm(date, getTimetable()), [date]);
